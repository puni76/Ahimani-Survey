...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    surveyAuthUserSubject.add(
      SurveyAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<SurveyAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  SurveyAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = SurveyAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    surveyAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
